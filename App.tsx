...
export default function App() {
    ...
    const [customers, setCustomers] = useLocalStorage<Customer[]>('sp-customers', []);
    const [products, setProducts] = useLocalStorage<Product[]>('sp-products', []);
    const [orders, setOrders] = useLocalStorage<Order[]>('sp-orders', []);
